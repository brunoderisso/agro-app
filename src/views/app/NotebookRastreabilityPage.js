...
import NotebookRastreabilityPage from "../../components/Notebook/NotebookRastreability/NotebookRastreabilityPage";
  ...
  return (
    <View>
      ...
      {flags.isValid && envId !== "" && cropid !== "" &&
        <Grid container >
          <MenuBar />
          <NotebookRastreabilityPage environment={envId} envCrop={cropid} />
        </Grid>
      }
    </View>
  );
