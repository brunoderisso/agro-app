...
import ServiceProfileEditPage from "../../components/Admin/ServiceProfile/ServiceProfileEditPage";
import AdminMenu from "../../components/Admin/AdminMenu";
import ServiceProfileAddPage from "../../components/Admin/ServiceProfile/ServiceProfileAddPage"
import history from "../../history";
import styles from "../../styles/Admin/Organization/OrganizationView"
import toolsUtils from "../../utils/toolsUtils";


export default withRouter(withStyles(styles)(function ServiceProfile(props) {
    ...
    useEffect(() => {
        ...
        if ((props.match.params.serv || "") !== profileId) {
            setProfileId(props.match.params.serv || "");
        };
        ...
        <Grid container >
            ...
            {flag &&
                <Grid>
                    ...
                    {profileId === "new" && <ServiceProfileAddPage organizationObjectID={organizationObjectId} />}
                    {profileId !== "new" && <ServiceProfileEditPage organizationID={organizationObjectId} serv={profileId} />}
                </Grid>}
        </Grid>
    );
