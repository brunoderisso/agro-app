...
import FunctionDrawerList from "./FunctionDrawerList"
...
export default withStyles(style)(function FunctionDrawer(props) {
    const [helperText, setHelperText] = useState(null);

    const { t } = useTranslation();

    useEffect(() => {
        setHelperText(metaStore.functionsHelpersText);
            ...
            <Grid container>
                ...
                >
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={12}>
                            <Grid container justifyContent="center" className={classes.title}>
                                <FunctionDrawerList onClose={onClose} view={props.view} />
                            </Grid>
                        </Grid>
                    </Grid>
                </Drawer>
