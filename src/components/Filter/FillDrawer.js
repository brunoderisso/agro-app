...
//Prediza
import FillDrawerList from "./FillDrawerList"
...
export default withStyles(style)(function FillDrawer(props) {
    ...
    useEffect(() => {
        setHelperText(metaStore.fillsHelpersText);
            ...
            <Grid container>
                ...
                >
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={12}>
                            <Grid container justifyContent="center" className={classes.title}>
                                <FillDrawerList onClose={onClose} />
                            </Grid>
                        </Grid>
                    </Grid>
                </Drawer>
