...
//Prediza
import MeasureDrawerList from "./MeasureDrawerList"
...
import Tooltype from '../Common/Tooltype';
...
export default withStyles(style)(function MeasureDrawer(props) {
    ...
    useEffect(() => {
        setHelperText(metaStore.measuresHelpersText);

        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, []);

    useEffect(() => {
        if ((props.view === "heatmap" || props.view === "report") && MeasureStore.measures.includes("all")) {
            ...
            <Grid container>
                ...
                >
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={12}>
                            <Grid container justifyContent="center" className={classes.title}>
                                <MeasureDrawerList view={props.view} onClose={onClose} />
                            </Grid>
                        </Grid>
                    </Grid>
                </Drawer>
